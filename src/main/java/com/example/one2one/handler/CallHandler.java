    ...
    public void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        switch (jsonMessage.get("id").getAsString()) {
            case "register":
                ...
                try {
                    this.register(session, jsonMessage);
                } catch (Throwable t) {
                    this.handleErrorResponse(t, session, "registerResponse");
                }
                break;
            case "call":
                try {
                    log.info("----------call user = {} , jsonMessage = {}  ------------- ", user, jsonMessage);
                    this.call(user, jsonMessage);
                } catch (Throwable t) {
                    this.handleErrorResponse(t, session, "callResponse");
                }
                break;
            case "incomingCallResponse":
                log.info("----------incomingCallResponse user = {} , jsonMessage = {}  ------------- ", user, jsonMessage);
                this.incomingCallResponse(user, jsonMessage);
                break;
            case "onIceCandidate": {
